# This example shows the use of tabPanels in a navlistPanel
#
...
ui <- fluidPage(
    ...
    column(9,
           h3("Column with Tabs"),
           hr(), # horizontal rule
           p("This example shows how to use navlistPanel. Notice how a 
             navlistPanel can be contained within another container, and
             how tabs can be grouped using simple headers."),
           navlistPanel(
               "Plot tabs",
               tabPanel("The Plot",
                        plotOutput("histplot"),
